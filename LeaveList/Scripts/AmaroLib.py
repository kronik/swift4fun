...
class AmaroLibModule(types.ModuleType):
    ...
    def targetingProduction(self):
        return self._configuration.endswith('Production') or self._configuration.endswith('Release')
    ...
    def isDistributionConfiguration(self):
        return self._configuration == 'Distribution' or self._configuration == 'Release'
